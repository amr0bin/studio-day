# Atlas verification record

Entries read on the organisation's own site, with the date. Distances are from Thurlow and Pendrell. From 5 September the Atlas also carries candidates as hollow markers marked verify; when one is read, by either of us, it becomes solid here and on the map.

**UBC, MFA in Visual Art** — read on grad.ubc.ca: two years full-time, private studio, TA-ships in foundation courses, 2027 intake opens 15 October 2026 and closes 8 January 2027, three references. Test (a). Verified 2026-09-05.

## Vancouver batch, 5 September 2026

**Basic Inquiry / The Vancouver Life Drawing Society** — 1011 Main Street, Vancouver. Volunteer-run registered charity, founded 1983; several uninstructed figure sessions a week from the live model; members exhibit in the studio gallery; tickets and passes through the Robostrar booking system, cheaper as a member. Test passed: (c) sustained access to the model near home. Source: https://lifedrawing.org/ (getting-here, book-a-session pages). Verified 2026-09-05. From the West End: Skytrain to Main Street–Science World, walk north.

**Kroma Artist's Acrylics** — Net Loft, 1649 Duranleau Street, Granville Island. Small-batch acrylics, mediums and gesso made on site since 1970; sold only direct, from the workshop, by phone or online; the maker, an Emily Carr graduate, has run it since 1993. Test passed: materials relationship; the sponsorship conversation is with the maker, not a distributor. Source: https://kromaacrylics.com/pages/about-kroma and /pages/contact. Verified 2026-09-05. From the West End: Aquabus from the foot of Hornby, or the 50 bus.

**Arts Umbrella** — 1400 Johnston Street, Granville Island (also Surrey Centre). Non-profit arts education for ages 2 to 22; ten visual arts studios on Granville Island; charitable registration 118852300 RR 0001; third-party fundraising events are welcomed and supported with donation forms, program information and signage, contact specialevents@artsumbrella.com; Splash is the annual donated-art auction. Test passed: the giving relationship, and a possible sponsor for a City of Vancouver CASC application. Source: https://www.artsumbrella.com/support/fundraising-events/ and /granville-island/. Verified 2026-09-05.

**Opus Art Supplies** — Downtown store on Granville Street; Granville Island store on Johnston Street. Free membership with cashback; in-store and online member events and demos; formal partnerships with the Federation of Canadian Artists and Emily Carr; a demo-artist application and a collaborator program exist on the site. Test passed: the workshop conversation has a named route (Demo Artist application, events page). Source: https://opusartsupplies.com (site navigation read on the paper product page). Verified 2026-09-05. Store addresses and the demo-artist terms still to be read on their own pages.
...
## Canada batch, 5 September 2026

**Banff Centre** — read on its own programs pages. Future Figurations thematic residency (body, embodied futurity; faculty Rajni Perera and Marigold Santos), 25 January to 26 February 2027, deadline 3 June 2026: missed, but proof the thematic calls fit this work. General BAiR deadlines run about seven months ahead. Source: https://www.banffcentre.ca/programs. Verified 2026-09-05.

**Vancouver Art Gallery** — 750 Hornby. That Green Ideal: Emily Carr, 6 February to 8 November 2026. Closed Tuesdays. Larwill Park move, no date. Test (c). Source: https://www.vanartgallery.bc.ca/ (own site) with dates from press. Verified 2026-09-05.

**National Gallery of Canada** — European and American collection page read; Gainsborough, Rembrandt, Vigée Le Brun; Tue–Sun 9:30–5; Marion Wagschal exhibition current. Portrait Gallery of Canada: no building, no collection, online only. Test (c). Source: https://www.gallery.ca/. Verified 2026-09-05.

**Art Gallery of Ontario** — European collection and Thomson Collection pages read; portrait miniatures; prints and drawings study centre, 70,000 works, public. Test (c). Source: https://ago.ca/collection/european. Verified 2026-09-05.

**Montreal Museum of Fine Arts** — Old Masters in the Hornstein Pavilion for Peace; 47,000 works; Wednesday evenings reduced to 23 September. Test (c). Source: https://www.mbam.qc.ca/. Verified 2026-09-05.

**NSCAD University** — MFA full-time, 20 to 23 months, 15 January deadline, painting/drawing area. Test (a), relocation only. Source: https://nscad.ca/program/master-of-fine-arts/. Verified 2026-09-05.

**OCAD University** — IAMD MFA, on campus; MA Criticism and Curatorial Practice. Part-time option seen only on a third-party site; confirm. Test (a). Source: https://gradadmissions.ocadu.ca/program/IAMD. Verified 2026-09-05.

## Museums abroad, first three, 5 September 2026

**National Portrait Gallery, London** — own site and FAQ read: 12,690 primary portraits, 8,564 works on paper, Heinz Archive reference collection; free; drop-in drawing; HSFK Award show 4 June to 6 September 2026. Test (c). Verified 2026-09-05.

**Mauritshuis, The Hague** — own visit page read: closed 24 August to 20 September 2026; Girl with a Pearl Earring away to 4 October; Alone with Vermeer 26 September to 3 January. Test (c). Verified 2026-09-05.

**Museo Morandi and Casa Morandi, Bologna** — read on Bologna Welcome, the city's official visitor portal, which links mambo-bologna.org; the museum's own page was not fetched. Closed Mondays; Casa Morandi free with booked ticket. Test (c). Verified 2026-09-05 via city portal.

## Libraries, first entry, 5 September 2026

**Vancouver Public Library, Central** — own pages read: BC Artists Files in Special Collections (Level 7, Tue–Sat 10–5); Inspiration Lab free recording and editing studios (Level 3); Level 8 exhibition space. Test (c), and a practical base for the Atlas research and the Foundations edit. Verified 2026-09-05.

**Emily Carr University Library + Archives** — alumni card free with ID and proof of address; 25 items; Artists' Books and Archives by appointment; archives from 1925 with alumni and faculty records. Verified 2026-09-05.

**Vancouver Art Gallery Library & Archives** — 50,000 volumes, 5,000 artist files, not public, research by appointment Mon–Thu; lists the Artists in Canada union database. Verified 2026-09-05.

**UBC Music, Art & Architecture Library** — artist vertical files, library use only, Level 3 desk. Verified 2026-09-05 (library research guide).

**National Gallery of Canada Library and Archives** — reading room public Tue–Fri 12–5 from 14 September 2026; archives by appointment; Artists in Canada database. Verified 2026-09-05.

Libraries still to read: Banff's Paul D. Fleck Library, AGO's E.P. Taylor Library, Artexte Montreal, NPG's Heinz Archive (noted on the NPG entry), Frick Art Reference Library, Watson Library (Met), National Art Library (V&A), Warburg Institute, RKD, Getty Research Institute.

**Equinox Gallery** — 3642 Commercial Street; Tue–Sat 10–5; no submissions route, relationships only. Maggee Day, Passing Notes, 12 September to 17 October 2026: paintings from a daily practice of quick sketches of ordinary objects. Test (b) and (c). Source: https://www.equinoxgallery.com/. Verified 2026-09-05.
